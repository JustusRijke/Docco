...
def extract_to_pot(content, output_path):
    ...
    po_content = markdown_to_pofile(content)
...
def build_from_po(content, po_path):
    ...
    Args:
        content: Original markdown content (single language)
    ...
    # Use mdpo to apply translations
    translated_content = pofile_to_markdown(content, po_path)
